  ...
  return (
    <section className="mb-12 relative overflow-hidden rounded-[2rem] bg-linear-to-bl from-accent dark:from-accent  to-background-inverse dark:to-background p-12 text-white">
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-[-20%] right-[-10%] w-[500px] h-[500px] bg-primary rounded-full blur-[100px]"></div>
        <div className="absolute bottom-[-10%] left-[-5%] w-[300px] h-[300px] bg-primary-container rounded-full blur-[80px]"></div>
      </div>
      <div className="relative z-10 max-w-2xl">
        ...
        <p className="text-lg text-primary-fixed opacity-90 font-body mb-8">
        ...
        <div className="flex space-x-4">
          <div className="bg-surface-container-lowest/10 backdrop-blur-md border border-white/10 p-4 rounded-2xl flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-xs text-primary-fixed">Socios Activos</p>
            </div>
          </div>
          <div className="bg-surface-container-lowest/10 backdrop-blur-md border border-white/10 p-4 rounded-2xl flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-xs text-primary-fixed">Crecimiento Mensual</p>
            </div>
          </div>
        </div>
      </div>
